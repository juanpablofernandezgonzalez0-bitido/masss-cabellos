...
import { deleteDebtPayment, editDebtPayment } from "@/lib/actions";
...
export function PaymentActions({ payment, debtId }: { payment: PaymentWithId; debtId: number }) {
  ...
  const handleEdit = async (e: React.FormEvent) => {
    ...
    try {
      await editDebtPayment(payment.id, formData);
      setEditing(false);
      router.refresh();
    } catch {
