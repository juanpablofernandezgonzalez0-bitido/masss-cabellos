...
export function InventoryFilter({ selectedYear, selectedMonth, selectedDate, currentYear }: Props) {
        ...
        <div className="min-w-[100px]">
          ...
          <div className="relative">
            <select
              ...
              className="w-full appearance-none rounded-lg border border-[var(--border)] bg-white py-2 pl-3 pr-8 text-sm font-medium text-[var(--foreground)] outline-none transition-colors focus:border-[#a18cd1] focus:ring-1 focus:ring-[#a18cd1]"
            >
              {yearOptions.map((y) => (
        ...
        <div className="min-w-[140px]">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[var(--border)] bg-white py-2 pl-9 pr-3 text-sm font-medium text-[var(--foreground)] outline-none transition-colors focus:border-[#a18cd1] focus:ring-1 focus:ring-[#a18cd1] [color-scheme:light]"
            />
          </div>
        </div>
